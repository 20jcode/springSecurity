...
public class JwtProvider {
	...
	//비밀키 세팅
	private final SecretKey secretKey = Keys.secretKeyFor(SignatureAlgorithm.HS256); //TODO : 보안문제 가능
	...
	@PostConstruct
	protected void init(){
		secretKey = Keys.secretKeyFor(SignatureAlgorithm.ES256).toString();
	} //TODO : 추가 공부 필요 부분
	...
	public String getUserPk(String token) {
		return Jwts.parserBuilder().build().parse(token).getBody().toString();
	}
